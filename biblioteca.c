...
void menuPrincipal(hotel *GLOBAL_dados_hotel, cad_clie *GLOBAL_dados_cliente, acomodacao *GLOBAL_dados_acomodacao, cate_aco *GLOBAL_dados_categ_acomodacao, produto *GLOBAL_dados_produtos,
    ...
    int GLOBAL_tam_pont_dados_entrega_produto = 1; //ja usado!
    int GLOBAL_tam_pont_dados_itens = 1; //ja usado!
    ...
    while (opcao != 0) {
        ...
        switch (opcao) {
            ...
            case 3:
                ...
                break;
            case 4:
                menuTipoAcomodacoes(binOUtxt, &GLOBAL_dados_categ_acomodacao, &GLOBAL_tam_pont_dados_categ_acomodacao);
                break;
            case 5:
                menuAcomodacoes(binOUtxt, GLOBAL_dados_categ_acomodacao, &GLOBAL_dados_acomodacao, GLOBAL_tam_pont_dados_categ_acomodacao, &GLOBAL_tam_pont_dados_acomodacao);
                break;
            case 6:
            ...
            case 8:
                ...
                break;
            case 9:
                menuTransacoes(binOUtxt, GLOBAL_dados_fornecedores, GLOBAL_tam_pont_dados_fornecedores, GLOBAL_dados_produtos, GLOBAL_tam_pont_dados_produtos, &GLOBAL_dados_entrega_produto, &GLOBAL_tam_pont_dados_entrega_produto, &GLOBAL_dados_itens, &GLOBAL_tam_pont_dados_itens, GLOBAL_dados_reservas, GLOBAL_tam_pont_dados_reservas, GLOBAL_dados_checkInOut, &GLOBAL_tam_pont_dados_checks);
                break;
            case 10:
    ...
    free(GLOBAL_dados_entrega_produto);
    free(GLOBAL_dados_itens);
