        ...
        switch (opcao) {
            case 1:
                ...
                if (tipoArquivo == 0) {
                    ...
                    salva_cadastro_acomodacao_mem(dados, &GLOBAL_dados_acomodacao, GLOBAL_dados_categ_acomodacao, GLOBAL_tam_pont_dados_categ_acomodacao, &(*GLOBAL_tam_pont_dados_acomodacao));
                }
                break;
            case 2:
